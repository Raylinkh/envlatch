...
struct CredentialMutationCoordinatorTests {
    ...
    @Test func endpointWriteFailureDoesNotTouchKeychain() throws {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("envlatch-mutation-blocked-\(UUID().uuidString)", isDirectory: true)
...
private struct MutationFixture {
    ...
    init() throws {
        root = FileManager.default.temporaryDirectory
            .appendingPathComponent("envlatch-mutation-\(UUID().uuidString)", isDirectory: true)
